...
<body>
  ...
  <form style="margin-top: 20px;" action="{{route('barang.update',$item->id)}}" method="POST" >
  @csrf
  @method('put')
    <div class="form-group row">
      <label for="nama" class="col-sm-2 col-form-label">Nama Barang</label>
      <div class="col-sm-10">
        <input type="text" name="nama_barang" class="form-control" id="nama" placeholder="" value="{!! $item->nama_barang !!}">
      </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="number" name="jumlah_barang" class="form-control" id="jumlah" placeholder="" value="{!! $item->jumlah_barang !!}">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="number" name="diskon"  step="0.0001" class="form-control" id="diskon" placeholder="" value="{!! $item->diskon !!}">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="date" name="tanggal_masuk" class="form-control" id="tanggal" placeholder="" value="{!! $item->tanggal_masuk !!}">
      </div>
    </div>
